    ...
    <>
      <div className="navbar glass fixed top-0 left-0 w-full z-50">
        <div className="flex-1">
          <Link to="/" className="btn btn-ghost text-xl text-orange-500">TokoOwren</Link>
          <label className="swap swap-rotate">
            ...
            {/* moon icon */}
            <svg
              className="swap-off h-10 w-10 fill-current text-orange-500"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            >
        ...
        <div className="flex-none">
          <ul className="menu menu-horizontal font-semibold px-1 text-orange-500">
            <li>
              <Link to="/">Home</Link>
            </li>
            <li>
